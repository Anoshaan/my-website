...
const DOMAINS: DomainLabel[] = [
  { text: "SaaS", top: "16%", size: "lg", dur: "41s", delay: "-5s", op: 0.82, rx: "70cqi" },
  { text: "Analytics Dashboards", top: "19.5%", size: "sm", dur: "52s", delay: "-22s", op: 0.54, rx: "36cqi" },
  { text: "E-Commerce", top: "23%", size: "lg", dur: "39s", delay: "-31s", op: 0.84, rx: "84cqi" },
  { text: "Booking Platforms", top: "26.5%", size: "sm", dur: "50s", delay: "-12s", op: 0.56, rx: "28cqi" },
  { text: "Game UI", top: "30%", size: "lg", dur: "43s", delay: "-3s", op: 0.8, rx: "58cqi" },
  { text: "Marketplace Apps", top: "33.5%", size: "sm", dur: "54s", delay: "-35s", op: 0.53, rx: "60cqi" },
  { text: "AI Platforms", top: "37%", size: "lg", dur: "40s", delay: "-17s", op: 0.85, rx: "20cqi" },
  { text: "HealthTech", top: "40.5%", size: "sm", dur: "49s", delay: "-8s", op: 0.56, rx: "76cqi" },
  { text: "Enterprise Software", top: "44%", size: "lg", dur: "44s", delay: "-27s", op: 0.8, rx: "46cqi" },
  { text: "EdTech", top: "47.5%", size: "sm", dur: "51s", delay: "-41s", op: 0.56, rx: "34cqi" },
  { text: "Mobile Apps", top: "51%", size: "lg", dur: "42s", delay: "-14s", op: 0.82, rx: "12cqi" },
  { text: "Creator Tools", top: "54.5%", size: "sm", dur: "53s", delay: "-2s", op: 0.55, rx: "66cqi" },
  { text: "Web Platforms", top: "58%", size: "lg", dur: "40s", delay: "-20s", op: 0.83, rx: "50cqi" },
  { text: "Productivity Tools", top: "61.5%", size: "sm", dur: "50s", delay: "-33s", op: 0.53, rx: "24cqi" },
  { text: "FinTech", top: "65%", size: "lg", dur: "43s", delay: "-7s", op: 0.84, rx: "80cqi" },
  { text: "Admin Portals", top: "68.5%", size: "sm", dur: "52s", delay: "-19s", op: 0.55, rx: "42cqi" },
  { text: "Food Tech", top: "72%", size: "lg", dur: "39s", delay: "-25s", op: 0.82, rx: "64cqi" },
  { text: "CRM Systems", top: "75.5%", size: "sm", dur: "49s", delay: "-10s", op: 0.56, rx: "30cqi" },
  { text: "Design Systems", top: "79%", size: "lg", dur: "41s", delay: "-38s", op: 0.8, rx: "54cqi" },
  { text: "Smart Agriculture", top: "82.5%", size: "sm", dur: "53s", delay: "-16s", op: 0.54, rx: "18cqi" },
];
